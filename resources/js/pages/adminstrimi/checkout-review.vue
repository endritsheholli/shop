      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="order-summary">
            ...
            <h4>
              ...
              >2 products in Cart</a>
            </h4>

            <div id="order-cart-section" class="collapse">
          ...
          <div class="checkout-info-box">
            <h3 class="step-title">
              ...
              <a href="#" title="Edit" class="step-title-edit">
                <span class="sr-only">Ndrysho</span>
                <i class="icon-pencil" />
              </a>
            </h3>
            ...
            <address>
              Desmond Mason
              <br>123 Street Name, City, USA
              <br>Los Angeles, California 03100
              <br>United States
              <br>(123) 456-7890
            </address>
          </div>
        ...
        <div class="col-lg-8 order-lg-first">
          <div class="checkout-payment">
            ...
            <div id="new-checkout-address" class="show">
              <form action="#">
                ...
                <div class="form-group-custom-control">
                  <div class="custom-control custom-checkbox">
                    <input id="address-save" type="checkbox" class="custom-control-input">
          ...
          <div class="checkout-discount">
            ...
            <div id="checkout-discount-section" class="collapse">
              <form action="#">
                <input
                  type="text"
